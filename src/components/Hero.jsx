    ...
    <div className="mt-24 max-w-[1200px] mx-auto relative">
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        ...
        >
          ...
          >
            HEY, I AM <br />
            <span className="text-purple-500 ">Arun Kumar HS</span>
          </motion.p>
          ...
          >
            ...
            <div className="flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20">
              <motion.a
                ...
                href="https://github.com/arun-1636"
              >
                <AiOutlineGithub />
              </motion.a>
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.linkedin.com/in/arunkumarhs04/"
              >
                <AiOutlineLinkedin />
              </motion.a>
              ...
              <motion.a
                whileHover={{ scale: 1.2 }}
                href="https://www.instagram.com/arunkumarhs04/?igsh=dHNmeXkyMDh4Zm8x&utm_source=qr#"
              >
                <AiOutlineInstagram />
              </motion.a>
            </div>
      ...
      >
        <p className="text-gray-200 text-xl tracking-tight leading-relaxed mr-6">
          My Tech Stack
        </p>
